...
## For example, CKPT="logs/Marco-Lite/BMI.bert-base-uncased.doc2query-t5-base-msmarco.realq_genq_docseg/kary=30.realq-ta-genq-docseg.small.dev.recall.dem=2.ada=1.adaeff=1.adanum=4.RDrop=0.1-0.15-0_lre2.0d1.0_epoch=30-recall1=0.609631.ckpt"
CKPT=""

## Data path. Replace the following with your own path
DATA_ROOT="data/Marco-Lite/output"
DATA_SUBDIR="BMI.bert-base-uncased.doc2query-t5-base-msmarco.realq_genq_docseg"
